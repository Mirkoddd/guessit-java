...
class ProbeTest {
    ...
    void dateSeries_titleKeepsSeries() {
        var r = parse("Date.Series.10-11-2008.XViD");
    ...
    void epiTypeEpisode_titleEpi() {
        var r = parse("epi", options().type("episode").build());
        assertThat(r.title()).isEqualTo("epi");
    }

    @Test
    void flexgetSeries() {
        var r = parse("FlexGet.Series.2013.14.of.21.Title.Here.720p.HDTV.AAC5.1.x264-NOGRP");
        assertThat(r.title()).isEqualTo("FlexGet Series");
    }

    @Test
    void fumetsuNoAnataE_keepsTrailingE() {
        var r = parse("[Erai-raws] Fumetsu no Anata e - 03 [720p][Multiple Subtitle].mkv");
    ...
    void sxxAll_yieldsSeasonAndCompleteOther() {
        var r = parse("Something.1xAll-FlexGet");
    ...
    void numXNumWithSpaces_seasonEpisodePair() {
        var r = parse("Something 1 x 2-FlexGet",
    ...
    void preferTitleWithYear_tagsEquivalentIgnore() {
        ...
        // title-cased hole.
        var r = parse("Foo Bar (2010)/foo.bar.2010.mkv");
        assertThat(r.title()).isEqualTo("Foo Bar");
    }

    @Test
    void subsAfterSubtitleLang_trailingDashRg() {
        var r1 = parse("Show.Name.S01E02.HDTV.x264.NL-subs-ABC");
    ...
    void subsDashRg_undSubtitleAndTrailingRg() {
        ...
        var r2 = parse("Family.Katta.2016.1080p.WEB-DL.H263.DD5.1.ESub-DDR");
    ...
    void chuckBerry320Kbps_typeMovie_noEpisode() {
        var r = parse("Chuck Berry The Very Best Of Chuck Berry(2010)[320 Kbps]");
    ...
    void epWordBeforeSxxExx_excludedFromTitle() {
        var r = parse("Star Trek DS9 Ep 2x03 The Siege (Part III)");
    ...
    void ymlLoaderParsesDashTOption() {
        var content = """
                ...
                : options: -t episode
                  ...
                  year: 2007
                """;
        var cases = parseContent(content, "probe");
    ...
    void showName476To479_episodeRange() {
        var r = parse("Show.Name.-.476-479.(2007).[HorribleSubs][WEBRip]..[HD.720p]");
    ...
    void showName313To315_dotsAbsoluteEpisode() {
        var r = parse("Show.Name.313-315.s16e03-05");
        assertThat(r.title()).isEqualTo("Show Name");
        var extras = r.extras();
        assertThat(extras == null ? null : (List<Integer>) extras.get("absolute_episode")).containsExactlyInAnyOrder(313, 314, 315);
    ...
    void s01Extras_seasonAndOtherExtras() {
        var r = parse("Series/My Name Is Earl/My.Name.Is.Earl.S01Extras.-.Bad.Karma.DVDRip.XviD.avi");
    ...
    void showName2_10_2016_animeContextKeepsWeakEpisode() {
        var r = parse("Show!.Name.2.-.10.(2016).[HorribleSubs][WEBRip]..[HD.720p]");
    ...
    void dimensionWTvDub_undLanguageAndTvSource() {
        var r = parse("[MK-Pn8].Dimension.W.-.05.[720p][Hi10][Dual][TV-Dub][EDA6E7F1]",
                options()
                        .allowedLanguages(of("und"))
                        .allowedCountries(of("us"))
                        .build());
    ...
    void splitScenesBetweenSourceAndContainer_notAltTitle() {
        ...
        assertThat(r.alternativeTitleList()).isEqualTo(of("Lola At Your Service"));
    ...
    void barFoodChristmasSpecial_episodeTypeViaSpecialDetail() {
        var r = parse("BarFood christmas special HDTV",
                options().expectedTitle(of("BarFood")).build());
    ...
    void queenAKindOfMagic_2cd_noCdAltTitle() {
        var r = parse("Queen - A Kind of Magic (Alternative Extended Version) 2CD 2014");
        assertThat(r.title()).isEqualTo("Queen");
        assertThat(r.alternativeTitleList()).isEqualTo(of("A Kind of Magic"));
    ...
    void huaMulan_hrAsReleaseGroup() {
        var r = parse("Hua.Mulan.BRRIP.MP4.x264.720p-HR.avi");
    ...
    void waveyObfuscated_titleNotReleaseGroup() {
        var r = parse("Season 06/e01.1080p.bluray.x264-wavey-obfuscated.mkv");
    ...
    void engineeringCatastrophes_wholeFilepartGroupKeepsTitle() {
        var r = parse("[ Engineering Catastrophes S02E10 1080p AMZN WEB-DL DD+ 2.0 x264-TrollHD ]");
    ...
    void daiseiFreeIwatobiCrcSwallowsSxxExx() {
        var r = parse("[Daisei] Free!：Iwatobi Swim Club - 01 ~ (BD 720p 10-bit AAC) [99E8E009].mkv");
    ...
    void insider_bonusTitleKeepsLeadingNumber() {
        var r = parse("The_Insider-(1999)-x02-60_Minutes_Interview-1996.mp4");
    ...
    void mindField_altTitleNotConvertedWhenAdjacentMatchUnrelated() {
        ...
        assertThat(r.alternativeTitleList()).isEqualTo(of("Mind Field"));
        assertThat(r.episodeTitle()).isNull();
    }
    ...
    void seasonNofN_chainedNofN_secondClauseIsEpisode() {
        var r = parse("Something.Season.2of5.3of9.Ep.Title.HDTV.torrent");
        assertThat(r.season()).isEqualTo(2);
    ...
    void seasonOnlyHead_dropsTrailingWeakBeforeEpisodeWord() {
        var r = parse("Show Name - S32-Dummy 45-Ep 6478");
        assertThat(r.title()).isEqualTo("Show Name");
    ...
    void wwiis_episodeTitleUpgradedFromOuterTitlecase() {
        var r = parse("WWIIs.Most.Daring.Raids.S01E04.Storming.Mussolinis.Island.1080p.WEB.h264-EDHD"
    ...
    void filenameHoleBeforeEpisodeMarker_isTitleNotEpisodeTitle() {
        var r = parse("Some Dummy Directory/Season 02/Some Series-E01.mkv");
    ...
    void filenameHoleBeforeEpisodeMarker_dedupesWithOuterTitle() {
        var r = parse("Some Series/Season 02/Some Series-E01.mkv");
        assertThat(r.title()).isEqualTo("Some Series");
        assertThat(r.season()).isEqualTo(2);
        assertThat(r.episode()).isEqualTo(1);
        assertThat(r.episodeTitle()).isNull();
    ...
    void nameOnlyOption_treatsSlashAsLiteral() {
        var opts = options().nameOnly(true).build();
        var r = parse("Paparazzi - Timsit/Lindon (MKV 1080p tvripHD)", opts);
        assertThat(r.title()).isEqualTo("Paparazzi");
        assertThat(r.alternativeTitleList()).isEqualTo(of("Timsit", "Lindon"));
    ...
    void websiteFollowedByDate_demotesToTitle() {
        ...
        Assertions.assertThat(r)
                .containsEntry("title", "PlayboyPlus com")
                .containsEntry("episode_title", "Eleni Corfiate Playboy Romania");
        assertThat(r.get("date")).hasToString("2023-01-16");
        assertThat(r).containsEntry("other", "XXX");
        assertThat(r.get("website")).isNull();
    }

    @Test
    void multipleSourceMatches_emitAsList() {
        var r = parse("dvd ts").toMap();
        assertThat(r).containsEntry("source", of("DVD", "Telesync"));
    }

    @Test
    void multiplePartMatches_emitAsList() {
        var r = parse("Show.Name.Part.1.and.Part.2.Blah-Group").toMap();
        Assertions.assertThat(r)
                .containsEntry("title", "Show Name")
                .containsEntry("part", of(1, 2));
    }
    ...
    void palindromeTail_outerSxxExxWinsAgainstWeakInnerSeasonEpisode() {
        ...
        Assertions.assertThat(r)
                ...
                .containsEntry("episode", 7)
                .containsEntry("release_group", "Q");
    }
    ...
    void trailingLanguageDash_promotesToReleaseGroup() {
        ...
        Assertions.assertThat(r)
                ...
                .containsEntry("release_group", "NL");
    ...
    void releaseGroupCasing_outerWinsWhenItHasEpisodeTitleHole() {
        ...
        Assertions.assertThat(r)
                .containsEntry("release_group", "WAT")
                .containsEntry("episode_title", "My Perspective");
    }
}
