...
class YearExtractorTest {
    ...
    @Test void simpleYear() {
        ...
        assertThat(((Match.IntegerMatch) ms.getFirst()).value()).isEqualTo(2015);
    }
    ...
    @Test void prefersGroupedYearWhenMultipleInFilepart() {
        ...
        Assertions.assertThat(ms).hasSize(1);
        assertThat(((Match.IntegerMatch) ms.getFirst()).value()).isEqualTo(2018);
    }
    ...
    @Test void boundaryValues() {
        assertThat(((Match.IntegerMatch) run("F.1920.mkv").getFirst()).value()).isEqualTo(1920);
        assertThat(((Match.IntegerMatch) run("F.2029.mkv").getFirst()).value()).isEqualTo(2029);
    }
}