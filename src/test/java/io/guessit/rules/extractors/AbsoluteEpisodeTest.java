...
class AbsoluteEpisodeTest {
    @Test void bleachTwoGroupsHigherBecomesAbsolute() {
        var r = parse("Bleach - s16e03-04 - 313-314");
        assertThat(r.episodeList()).containsExactlyInAnyOrder(3, 4);
        assertThat(field(r, "absolute_episode")).isEqualTo(of(313, 314));
    }
    @Test void hatsuyukiAnimeRangeWithParensAbsolute() {
        var r = parse("[Hatsuyuki-Kaitou]_Fairy_Tail_2_-_16-20_(191-195)_[720p][10bit].torrent");
        assertThat(r.episodeList()).contains(16, 17, 18, 19, 20);
        assertThat(field(r, "absolute_episode")).isEqualTo(of(191, 192, 193, 194, 195));
    }
