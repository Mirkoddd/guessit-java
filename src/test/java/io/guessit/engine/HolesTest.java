...
class HolesTest {
    @Test void computeReturnsGapsBetweenMatches() {
        ...
        var matches = of(
                Match.of(YEAR, 2020, new Span(11, 15, "2020")),
                Match.of(SCREEN_SIZE, "1080p", new Span(16, 21, "1080p")),
                Match.of(VIDEO_CODEC, "H.264", new Span(22, 26, "x264")));
    ...
    @Test void ignoredMatchesAreTransparent() {
        ...
        var matches = of(Match.of(LANGUAGE, "en", new Span(6, 11, "world")));
    ...
    @Test void emptyHoleSkipped() {
        var input = "ab";
        var matches = List.of(Match.of(G, null, new Span(0, 2, "ab")));
