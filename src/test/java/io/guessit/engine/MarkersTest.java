...
class MarkersTest {
    ...
    @Test void namedFiltersByName() {
        var markers = List.of(
                new Marker("path", new Span(0, 5, "12345")),
                new Marker("group", new Span(1, 4, "234")),
                new Marker("path", new Span(6, 10, "6789")));
        var paths = Markers.named(markers, "path").toList();
        assertThat(paths).hasSize(2);
    }

    @Test void atMatchReturnsContainingMarker() {
        var markers = List.of(new Marker("path", new Span(0, 10, "0123456789")));
    ...
    @Test void markerSortedByDescendingMatchCount() {
        var p1 = new Marker("path", new Span(0, 5, "0..4"));
        var p2 = new Marker("path", new Span(6, 12, "6..11"));
